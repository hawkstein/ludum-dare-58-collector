...
func create_frostbolt() -> SpellEntry:
	...
	frostbolt_entry.add_attribute("slow", _create_values(2.0, 4, [2,0,0,0], 1.5))
...
func create_rockblast() -> SpellEntry:
	...
	rockblast_entry.add_attribute("rate", _create_values(10.0, 4, [0,1,2,0], 0.75))
	rockblast_entry.add_attribute("damage", _create_values(10.0, 4, [0,0,2,1], 2))
